...
const projectsInSrilanka = [
  {title:"TA-9590 SRI: Capacity Building for Secondary Towns and Strategic Cities",},
...
const ProjectsInSrilanka: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#F5F2EB] flex flex-col">
      ...
      <div className="flex-grow container mx-auto px-6 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {projectsInSrilanka.map((project, index) => (
            <div
              key={index}
...
export default ProjectsInSrilanka;
